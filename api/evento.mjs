 ...
 *
 * Copia do endpoint do site quezada.com.br (repo tuka-junq/quezada-site),
 * apontada para o pixel da landing page.
 *
 * Variaveis de ambiente (Vercel > projeto quezada-lp > Settings > Environment Variables):
 *   META_PIXEL_ID    1101830205873544  (Pixel - LP Quezada Consult)
 *   META_CAPI_TOKEN  token gerado no Events Manager para esse pixel
 */
...
// Lead_Q = enviou o diagnostico do Raio-X; Lead_F = qualquer outro WhatsApp.
const EVENTOS_PERMITIDOS = new Set(['Lead_Q', 'Lead_F', 'ViewContent', 'PageView']);

const ORIGENS_PERMITIDAS = [
  'https://quezadaconsultoria.com.br',
  'https://www.quezadaconsultoria.com.br',
];
